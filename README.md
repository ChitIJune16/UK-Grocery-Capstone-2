...
## Key Outcomes:
Distribution is the strongest driver of unit sales
Price changes have minimal effect on most items
Random Forest delivered the highest predictive accuracy
+10% distribution → +8.64% unit lift
–10% price → +1.18% unit lift
